/**
 * 表情动画清单 — 命名规范: 所有符号以文件夹名 "e_" 为前缀
 * 帧文件: /spiffs/e_00.bin .. e_18.bin
 *
...
/* 帧数 */
#define E_FRAME_COUNT  19

/* 默认全局帧率 (仅对 duration_ms=0 的帧生效) */
#define E_DEFAULT_FPS  8

/* 帧序表 — 可编辑顺序和每帧时长 */
static const e_anim_frame_t e_sequence[] = {
    { 0, 300, 0, 0},   /* 帧0: 300ms */
    { 1, 300, 0, 0},   /* 帧1: 300ms */
    { 2, 300, 0, 0},   /* 帧2: 300ms */
    { 3, 300, 0, 0},   /* 帧3: 300ms */
    ...
    { 16, 300, 0, 0},  /* 帧16: 300ms */
    { 17, 300, 0, 0},  /* 帧17: 300ms */
    { 18, 300, 0, 0},  /* 帧18: 300ms */
};
#define E_SEQ_LEN  (sizeof(e_sequence) / sizeof(e_sequence[0]))
